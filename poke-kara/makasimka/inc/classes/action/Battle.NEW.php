    ...
    public function __construct(ActionBattle $actionBattle, array &$info_1, array &$info_2, array &$target_1, array &$target_2) {
        ...
        if (isset($target_1['id'], $target_2['id'])) {
            ...
            if (!empty($atk_1) && !empty($atk_2)) {
                ...
                if ($atk_1['id'] == 320) {
                    $metr = mt_rand(1, 677);
                    $metronom = Work::$sql->query("SELECT * FROM base_atk WHERE id = $metr")->fetch_assoc();
                    if ($metronom['tech'] != '<font color=green>Атака работает исправно</font>' || in_array($metronom['id'], [9, 320, 240, 688, 413, 22, 13])) {
                        ...
                        shuffle($metr);
                        $metronom = Work::$sql->query("SELECT * FROM base_atk WHERE id = " . $metr[0])->fetch_assoc();
                    }
                    $poke_1->metronom = 1;
...
private function hit(PokeBattle &$attacker, PokeBattle &$defender, array &$attackerAtk, array &$defenderAtk){
					...
					if($this->defender->atk_before < 9000) {
						if(in_array($this->defender->atk_before, [754,753,481,528,574])) {
							...
							if($this->_actionBattle->round == 1) {
								...
								$metronom = Work::$sql->query("SELECT * FROM base_atk WHERE id = ".$this->defender->atk_before)->fetch_assoc();
        ...
        if(!$this->attacker->_checkStatus('levitation')) {
          if($this->attacker->ability == 96 and $this->defender->ability != 113) {
            ...
            $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> позволяет '.$this->attacker->_getName(true).' левитировать.';
          }
        }
    ...
    $this->log[] = 'Тип атаки изменен на: '.$hptypenumrus[$hptype];
        ...
        if($this->attacker->ability == 2) {
          if($this->attackerAtk['type'] == 'normal') {
            ...
            $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> меняет тип атаки на Летающий.';
          }
        }

        if($this->attacker->ability == 76) {
          $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> увеличивает стат Атаки в 2 раза.';
        }

        if($this->attacker->ability == 146) {
          $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> увеличивают Скорость на 50%.';
        }

        if($this->attacker->ability == 63) {
          $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> увеличивает стат Защиты в 2 раза.';
        }

        if($this->attacker->ability == 68) {
          $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> увеличивает стат Защиты на 50%.';
        }

        if($this->attacker->ability == 37) {
          if($this->attacker->hp <= floor(($this->attacker->hp_max / 2))){
            $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> понижает статы Атаки и Спец. Атаки в 2 раза.';
          }
        }
...
if ($this->attacker->hp > 0 && $this->defender->hp > 0) {
    ...
    if (in_array($tgt, ['enemy','enemy_random','all_enemy'])) {
        ...
        if (isset($this->attackerAtk['id']) && in_array($this->attackerAtk['id'], [90,391,393,418,490,515,530])
            ...
            $this->log[] = 'Атака не действует: цель защищена способностью <div class="Ability" onclick="issetAll(125,\'ability\')">'.Info::getAbilityBase(['id',125,'name_rus']).'</div>.';
            return;
        }
        ...
        if (isset($this->attackerAtk['id']) && in_array($this->attackerAtk['id'], [554,571,143,111,226])
            ...
            $this->log[] = 'Эффект заблокирован способностью <div class="Ability" onclick="issetAll(9,\'ability\')">'.Info::getAbilityBase(['id',9,'name_rus']).'</div>.';
            return;
        }
        ...
        if (!empty($this->attackerAtk['sound']) && $this->attackerAtk['sound'] == 1
            ...
            $this->log[] = 'Звуковой приём не действует из-за <div class="Ability" onclick="issetAll(183,\'ability\')">'.Info::getAbilityBase(['id',183,'name_rus']).'</div>.';
            return;
        }
        ...
        if (!empty($this->attackerAtk['bullet']) && $this->attackerAtk['bullet'] == 1
            ...
            $this->log[] = 'Атака-проектайл не действует из-за <div class="Ability" onclick="issetAll(19,\'ability\')">'.Info::getAbilityBase(['id',19,'name_rus']).'</div>.';
            return;
        }
        ...
        if (isset($this->attackerAtk['type']) && $this->attackerAtk['type'] === 'fire'
            ...
            if (!$this->defender->_checkStatus('flash_fire')) {
                ...
                $this->log[] = '<div class="Ability" onclick="issetAll(54,\'ability\')">'.Info::getAbilityBase(['id',54,'name_rus']).'</div> поглощает огонь и усиливает огненные атаки цели.';
            } else {
                $this->log[] = '<div class="Ability" onclick="issetAll(54,\'ability\')">'.Info::getAbilityBase(['id',54,'name_rus']).'</div> поглощает огонь.';
            }
            return;
        }
        ...
        if (isset($this->attackerAtk['type']) && $this->attackerAtk['type'] === 'electric'
            ...
            $this->log[] = '<div class="Ability" onclick="issetAll(98,\'ability\')">'.Info::getAbilityBase(['id',98,'name_rus']).'</div> перенаправляет электричество: <span class="StatPlus">Спец.Атака +1</span>.';
            return;
        }

        /* Motor Drive (id=115): иммунитет к Electric и +1 Speed (как в Pokemon Showdown; игнорится 113) */
        if (isset($this->attackerAtk['type']) && $this->attackerAtk['type'] === 'electric'
            && $this->defender->ability == 115 && $this->attacker->ability != 113) {
            $this->defender->_setModifiedStat('spd', 1, true);
            $this->log[] = '<div class="Ability" onclick="issetAll(115,\'ability\')">'.Info::getAbilityBase(['id',115,'name_rus']).'</div> поглощает электричество: <span class="StatPlus">Скорость +1</span>.';
            return;
        }
        ...
        if (isset($this->attackerAtk['type']) && $this->attackerAtk['type'] === 'water'
            ...
            $this->log[] = '<div class="Ability" onclick="issetAll(225,\'ability\')">'.Info::getAbilityBase(['id',225,'name_rus']).'</div> восстанавливает здоровье цели: <span class="HpPlus">+'.$heal.' HP</span>.';
            return;
        }

        /* Storm Drain (id=194): иммунитет к Water и +1 Sp.Atk (как в Pokemon Showdown; игнорится 113) */
        if (isset($this->attackerAtk['type']) && $this->attackerAtk['type'] === 'water'
            && $this->defender->ability == 194 && $this->attacker->ability != 113) {
            $this->defender->_setModifiedStat('satk', 1, true);
            $this->log[] = '<div class="Ability" onclick="issetAll(194,\'ability\')">'.Info::getAbilityBase(['id',194,'name_rus']).'</div> поглощает воду: <span class="StatPlus">Спец.Атака +1</span>.';
            return;
        }
        ...
        if (isset($this->attackerAtk['type']) && $this->attackerAtk['type'] === 'electric'
            ...
            $heal = max(1, (int)floor($this->defender->hp_max / 4));
            $this->defender->hp = min($this->defender->hp_max, $this->defender->hp + $heal);
            $this->log[] = '<div class="Ability" onclick="issetAll(224,\'ability\')">'.Info::getAbilityBase(['id',224,'name_rus']).'</div> восстанавливает здоровье цели: <span class="HpPlus">+'.$heal.' HP</span>.';
            return;
        }
        ...
        if (isset($this->attackerAtk['type']) && $this->attackerAtk['type'] === 'water'
            ...
            $heal = max(1, (int)floor($this->defender->hp_max / 4));
            $this->defender->hp = min($this->defender->hp_max, $this->defender->hp + $heal);
            $this->log[] = '<div class="Ability" onclick="issetAll(45,\'ability\')">'.Info::getAbilityBase(['id',45,'name_rus']).'</div> восстанавливает здоровье от воды: <span class="HpPlus">+'.$heal.' HP</span>.';
            return;
        }
        ...
        if (isset($this->attackerAtk['type']) && $this->attackerAtk['type'] === 'grass'
            ...
            $this->log[] = '<div class="Ability" onclick="issetAll(162,\'ability\')">'.Info::getAbilityBase(['id',162,'name_rus']).'</div> делает цель невосприимчивой к траве и повышает <span class="StatPlus">Атаку +1</span>.';
            return;
        }
...
/* === /ИММУНИТЕТЫ/ПОГЛОЩЕНИЯ === */
        ...
        if($this->attacker->item_id == 190) {
          if($this->attacker->_checkStatus('burn') || $this->attacker->_checkStatus('toxic') || $this->attacker->_checkStatus('toxic2') || $this->attacker->_checkStatus('sleep') || $this->attacker->_checkStatus('paralyzed') || $this->attacker->_checkStatus('frost')) {
            ...
            if($this->attacker->_getTypeA() == 'poison' || $this->attacker->_getTypeB() == 'poison' || $this->attacker->_getTypeA() == 'steel' || $this->attacker->_getTypeB() == 'steel' || $this->attacker->_checkStatus('safeguard')) {
              ...
              $this->attacker->_setStatus('toxic2', 9999, 0);
              ...
              $this->log[] = 'Сильное отравление нанесёт урон в конце хода: <span class="HpMinus">-'.$__toxicDmg.' HP</span>';
              // ▲ ДОБАВЛЕНО
        ...
        if($this->attacker->ability == 22 && $this->_actionBattle->weather == 2 && !in_array(4,[$this->attacker->ability,$this->defender->ability])) {
          $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> увеличивает <span class="StatPlus">Скорость +100%</span>';
        }
        ...
        if($this->attacker->ability == 108 and $this->defender->ability != 113) {
          if($this->attacker->_checkStatus('toxic') || $this->attacker->_checkStatus('toxic2') || $this->attacker->_checkStatus('sleep') || $this->attacker->_checkStatus('burn') || $this->attacker->_checkStatus('frost') || $this->attacker->_checkStatus('paralyzed')) {
            $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> увеличивает <span class="StatPlus">Защиту +50%</span>';
          }
        }
          ...
          if($pList){
            ...
            if($randheal72 <= 100) {
              ...
              if($pokabil72 != '') {
                ...
                $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> избавляет случайного союзника от негативных статусов.'
          ...
          if($this->attackerAtk['type'] == 'water'){
            ...
            $this->attackerAtk['power'] = $this->attackerAtk['power'] / 1.5;
		      ...
		      if($this->attacker->_getStatSpd() < $this->defender->_getStatSpd()) {
		        ...
		        $movecopy =  Work::$sql->query('SELECT * FROM base_atk WHERE id = '.$this->attackerAtk['id'])->fetch_assoc();
		      ...
		      if($infoTwoTurn){
		        foreach($infoTwoTurn AS $key=>$value){
		          if($value['type'] == 'two_turn'){
		            $atkTwoRnd = Work::$sql->query("SELECT * FROM base_atk WHERE id = ".$value['val'])->fetch_assoc();
		            $this->attackerAtk['id'] = $atkTwoRnd['id'];
		            $this->attackerAtk['name'] = $atkTwoRnd['name_rus'];
		            $this->attackerAtk['type'] = $atkTwoRnd['type'];
		            $this->attackerAtk['category'] = $atkTwoRnd['category'];
          ...
          if($mypp[$this->attackerAtk['attack_num']] >= 1) {
              if($mypp[$this->attackerAtk['attack_num']]) {
								if($this->defender->ability == 139) {
									$minus_pp = 2;
									$this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника крадет 1 дополнительно PP у покемона.';
								}else{
									$minus_pp = 1;
								}
									...
									if($this->abil_flashfire($this->attacker, $this->defender, $this->attackerAtk, $this->defenderAtk)) {
                                        ...
                                        if($this->abil_dryskin($this->attacker, $this->defender, $this->attackerAtk, $this->defenderAtk)) {
                                            ...
                                            if($this->abil_voltabsorb($this->attacker, $this->defender, $this->attackerAtk, $this->defenderAtk)) {
                                              ...
                                              {
                                                $this->defender->_setModifiedStat('satk', 1, true);
                                                $this->log[] = '<div class="Ability" onclick="issetAll(194,\'ability\')">'.Info::getAbilityBase(['id',194,'name_rus']).'</div> делает покемона невосприимчивым к воде и повышает <span class="StatPlus">Спец. Атаку +1</span>.';
                                              ...
                                              {
                                                $this->defender->_setModifiedStat('spd', 1, true);
                                                $this->log[] = '<div class="Ability" onclick="issetAll(115,\'ability\')">'.Info::getAbilityBase(['id',115,'name_rus']).'</div> делает покемона невосприимчивым к электричеству и повышает <span class="StatPlus">Скорость +1</span>.';
                                                $this->attackerAtk['power'] = 0; // урон блокирован
                                              }
			              ...
			              //                     }
									  ...
									  // }
										...
										if(in_array($this->attackerAtk['type'], ['bug','dark','ghost']) && $this->defender->ability == 148) {
										  $this->defender->_setModifiedStat('spd', 1, true);
			                              $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника увеличивает <span class="StatPlus">Скорость +1</span>';
									  }
			                          ...
			                          if($this->attackerAtk['id'] == 278) {
                                        ...
                                        if($ability52_done == 0 && $this->settings['types'] > 0 
                                          ...
                                          && $this->attacker->hp > 0) 
                                        {
                                          ...
                                          if($rand_fb <= 30) {
                                            if($this->attacker->_checkStatus('terrMisty') || $this->attacker->_checkStatus('sleep') || $this->attacker->_checkStatus('safeguard') || $this->attacker->ability == 226 || $this->attacker->ability == 228 || in_array('fire',[$this->attacker->_getTypeA(),$this->attacker->_getTypeB()]) || $this->attacker->_checkStatus('burn') || $this->attacker->_checkStatus('toxic') || $this->attacker->_checkStatus('toxic2') || $this->attacker->_checkStatus('paralyzed') || $this->attacker->_checkStatus('frost')) {
                                              $this->log[] = 'Провал изменения статуса.';
                                            } else {
                                              if($this->attacker->_setStatus('burn', 9999)){
                                              $__burnDmg = max(1, floor($this->attacker->hp_max / 16)); // 1/16 HP
                                              $this->log[] = '<div class="Ability" onclick="issetAll(52,\'ability\')">'.Info::getAbilityBase(['id',52,'name_rus']).'</div> противника накладывает ожог. Урон в конце хода: <span class="HpMinus">-'.$__burnDmg.' HP</span>';
                                              $this->trySynchronizeBack('burn');
                                              }
                                            }
                                          }
                                        }
                                        ...
                                        if($ability134_done == 0 && $this->settings['types'] > 0 
                                          && $this->attackerAtk['contact'] == 1
                                          ...
                                          && $this->attacker->hp > 0) 
                                        {
                                          ...
                                          if($rand_pp <= 30) {
                                            if($this->attacker->_checkStatus('terrMisty') || $this->attacker->_checkStatus('sleep') || $this->attacker->_checkStatus('safeguard') || in_array('poison',[$this->attacker->_getTypeA(),$this->attacker->_getTypeB()]) || in_array('steel',[$this->attacker->_getTypeA(),$this->attacker->_getTypeB()]) || $this->attacker->_checkStatus('burn') || $this->attacker->_checkStatus('toxic') || $this->attacker->_checkStatus('toxic2') || $this->attacker->_checkStatus('paralyzed') || $this->attacker->_checkStatus('frost')) {
                                              ...
                                              if($this->attacker->_setStatus('toxic', 9999)){ // обычный яд
                                              $__poisonDmg = max(1, floor($this->attacker->hp_max / 8)); // 1/8 HP
                                              $this->log[] = '<div class="Ability" onclick="issetAll(134,\'ability\')">'.Info::getAbilityBase(['id',134,'name_rus']).'</div> противника отравляет покемона. Урон в конце хода: <span class="HpMinus">-'.$__poisonDmg.' HP</span>';
                                              $this->trySynchronizeBack('toxic');
                                              }
                                            }
                                          }
                                        }
			                          ...
			                          if($this->settings['types'] > 0 && $this->defender->ability == 189 && $this->attackerAtk['contact'] == 1) {
			                            ...
			                            if($rand189 <= 30) {
			                              if($this->attacker->_checkStatus('terrMisty') || $this->attacker->_checkStatus('sleep') || $this->attacker->_checkStatus('safeguard') || $this->attacker->_getTypeA() == 'electric' || $this->attacker->_getTypeB() == 'electric' || $this->attacker->_checkStatus('burn') || $this->attacker->_checkStatus('toxic') ||$this->attacker->_checkStatus('toxic2') || $this->attacker->_checkStatus('paralyzed') || $this->attacker->_checkStatus('frost')) {
			                                ...
			                                if($this->attacker->_setStatus('paralyzed', 9999)){
			                                $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника парализует покемона.';
																$this->trySynchronizeBack('paralyzed');
																	}
			                              }
			                            }
			                          }
    ...
    if($rand_cursed <= 30) {
        ...
        $this->log[] = '<div class="Ability" onclick="issetAll(31,\'ability\')">Проклятое тело</div> блокирует атаку '.$this->attackerAtk['name'].' у '.$this->attacker->_getName(true).' на 4 хода!';
			                          ...
			                          if($this->settings['types'] > 0 && $this->defender->ability == 92 && $this->attackerAtk['type'] == 'dark' && $this->attackerAtk['power'] >= 1) {
			                            $this->defender->_setModifiedStat('atk', 1, true);
			                            $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника увеличивает <span class="StatPlus">Атаку +1</span>';
			                          }
			                          ...
			                          if($this->settings['types'] > 0 && $this->defender->ability == 243 && $this->attacker->ability != 23 && $this->attackerAtk['contact'] == 1 && $this->attackerAtk['power'] >= 1) {
			                            ...
			                            $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника понижает <span class="StatPlus">Скорость -1</span>';
			                          }
			                          ...
			                          if($this->settings['types'] > 0 && $this->defender->ability == 237 && ($this->attackerAtk['type'] == 'water' or $this->attackerAtk['type'] == 'fire')  && $this->attackerAtk['power'] >= 1) {
			                            ...
			                            $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника увеличивает <span class="StatPlus">Скорость +6</span>';
			                          }
...
if($this->settings['types'] > 0 &&  $this->defender->ability == 238 && $this->_actionBattle->weather != 5 && $this->attackerAtk['power'] >= 1) {
                  ...
                  $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> меняет погоду на Песчаную бурю.';
			                          }

			                          if($ability52_done == 0 && $this->settings['types'] > 0 && $this->attackerAtk['contact'] == 1 && $this->defender->ability == 52) {
    ...
    if($rand52 <= 30) {
        if(
            ...
            if($this->attacker->ability == 226 || $this->attacker->ability == 228){
                $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> защищает от поджога.';
            }else{
                $this->attacker->_setStatus('burn', 9999);
                $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника поджигает покемона.';
            }
        }
    }
}

if($ability134_done == 0 && $this->settings['types'] > 0 && $this->attackerAtk['contact'] == 1 && $this->defender->ability == 134) {
    ...
    if($rand134 <= 30) {
        if(
            ...
            $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника отравляет покемона.';
        }
    }
}
...
if ($this->settings['types'] > 0 && $this->attackerAtk['contact'] == 1 && $this->defender->ability == 47) {
    ...
    if ($rand47 <= 30) {
        ...
        foreach ($candidates as $stype) {
            ...
            if(in_array($stype, ['burn','toxic','paralyzed'])){
              $this->trySynchronizeBack($stype);
            }
    ...
    if($rand108 <= 30) {
        if($this->attacker->_checkStatus('lover') || $this->attacker->_getSex() == $this->defender->_getSex() || $this->attacker->_getSex() == 'Бесполый') {
            ...
            if($this->attacker->_checkStatus('safeguard')) {
                ...
                $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника заставляет влюбиться в покемона.';
            }
        }
    }
}
...
if($this->attackerAtk['id'] == 108){
    $this->attacker->desteny_bond = 1;
                                ...
                                if(in_array($this->defender->ability, [23,230,62])) { // Clear Body, White Smoke, Full Metal Body
                                  $canLower = false;
                                  $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника не дает понизить ему стат.';
                                }
                                ...
                                if($canLower && $this->defender->ability == 236) { // Mirror Armor
                                  if(!($this->attacker->_checkStatus('defstat') && $this->defender->ability != 85)) {
                                    if($this->attacker->ability == 29){ // Contrary
                                      ...
                                      $this->log[] = '<div class="Ability" onclick="issetAll(236,\'ability\')">'.Info::getAbilityBase(['id',236,'name_rus']).'</div> отражает понижение: Скорость атакующего повышена на 1 из-за <div class="Ability" onclick="issetAll(29,\'ability\')">'.Info::getAbilityBase(['id',29,'name_rus']).'</div>.';
                                    }else{
                                      $this->attacker->_setModifiedStat('spd', 1, false);
                                      $this->log[] = '<div class="Ability" onclick="issetAll(236,\'ability\')">'.Info::getAbilityBase(['id',236,'name_rus']).'</div> отражает понижение: Скорость атакующего понижена.';
                                    }
                                  } else {
                                ...
                                if($canLower){
                                  if($this->defender->ability == 23){
                                    $this->log[] = '<div class="Ability" onclick="issetAll(23,\'ability\')">'.Info::getAbilityBase(['id',23,'name_rus']).'</div> противника не дает понизить ему стат.';
                                  }else{
                                      ...
                                      if(in_array($this->defender->ability, [23,230,62])){ // Clear Body, White Smoke, Full Metal Body
                                        ...
                                        if(!($this->attacker->_checkStatus('defstat') && $this->defender->ability != 85)){
                                          if($this->attacker->ability == 29){ // Contrary
                                            ...
                                            $this->log[] = '<div class="Ability" onclick="issetAll(236,\'ability\')">'.Info::getAbilityBase(['id',236,'name_rus']).'</div> отражает понижение: Скорость атакующего повышена на 2 из-за <div class="Ability" onclick="issetAll(29,\'ability\')">'.Info::getAbilityBase(['id',29,'name_rus']).'</div>.';
                                          }else{
                                            $this->attacker->_setModifiedStat('spd', 2, false);
                                            $this->log[] = '<div class="Ability" onclick="issetAll(236,\'ability\')">'.Info::getAbilityBase(['id',236,'name_rus']).'</div> отражает понижение: Скорость атакующего значительно понижена';
                                          }
                                        }else{
                                          $this->log[] = 'Отражение понижения отменено защитой.';
                                        }
                                      ...
                                      if(in_array($this->defender->ability, [23,230,62])){ // Clear Body / White Smoke / Full Metal Body
                                        ...
                                        if(!($this->attacker->_checkStatus('defstat') && $this->defender->ability != 85)){
                                          if($this->attacker->ability == 29){ // Contrary
                                            ...
                                            $this->log[] = '<div class="Ability" onclick="issetAll(236,\'ability\')">'.Info::getAbilityBase(['id',236,'name_rus']).'</div> отражает понижение: Спец. Атака атакующего значительно повышена из-за <div class="Ability" onclick="issetAll(29,\'ability\')">'.Info::getAbilityBase(['id',29,'name_rus']).'</div>.';
                                          }else{
                                            $this->attacker->_setModifiedStat('satk', 2, false);
                                            $this->log[] = '<div class="Ability" onclick="issetAll(236,\'ability\')">'.Info::getAbilityBase(['id',236,'name_rus']).'</div> отражает понижение: Спец. Атака атакующего значительно понижена';
                                          }
                                        }else{
                                          $this->log[] = 'Отражение понижения отменено защитой.';
                                        }
                              ...
                              if($this->attackerAtk['id'] == 602 && $this->_actionBattle->_isPVP()) {
                                ...
                                if(in_array($this->defender->ability, [197,271])){ // Suction Cups, Guard Dog
                                  $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> предотвращает вынуждение к замене.';
                                }else{
                            ...
                            if($this->attackerAtk['category'] == 'status' || $this->attackerAtk['category'] == 'specific'){
                              ...
                              if($this->attackerAtk['id'] == 277) {
                                ...
                                if($this->attacker->form == 5) {
                                  ...
                                  $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> меняет форму на Щит.';
                                }
                                $poke = Work::$sql->query("SELECT * FROM battle_block WHERE pokID = ".$attacker->id)->fetch_assoc();
                                if(isset($poke)) {
                                  $rand = mt_rand(1,100);
        ...
        foreach($order as $stype){
            foreach($info as $key=>$value){
                if($value['type'] == $stype){
                    ...
                    $immune = false;
        if ($this->attacker->_checkStatus('safeguard') || $this->attacker->_checkStatus('terrMisty')) {
            $immune = true;
        }
...
if($this->attackerAtk['id'] == 678) {
    $this->getAAM($this->attacker, $this->defender, $this->attackerAtk, $this->defenderAtk);
                          ...
                          if(!$this->_actionBattle->_isPVP() && $this->attacker->ability == 157) {
                            ...
                            $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> помогает убежать покемону с битвы.';
...
if($this->attackerAtk['id'] == 206){
    ...
    if($this->attacker->_checkStatus('gravity') || $this->defender->_checkStatus('gravity')) {
        ...
        if($this->defender->ability == 23 || $this->defender->ability == 62) {
            $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> мешает снижению Ловкости.';
        }else{
        ...
        if($this->attacker->ability == 23 || $this->attacker->ability == 62) {
            $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> мешает снижению Ловкости.';
        }else{
...
if($this->attackerAtk['id'] == 107){
    ...
    if(($this->defender->ability == 23) || ($this->defender->ability == 62)){
        $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> не даёт понизить Ловкость.';
    }else{
...
$this->settings['crash'] = false;
  ...
  if(isset($info_enemy['stats'])) {
        ...
        if($rand_info_enemy <= $value['3']) {
            ...
            $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника не дает понизить ему стат.';
                ...
                if($this->defender->ability == 236){
                    $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> отражает понижение характеристик.';
                    if($this->settings['types'] > 0) {
                        $this->attacker->_setModifiedStat($value[0], $value[1], ($value[2] == 'minus' ? false : true));
            if($value[0] == 'atk'){
              $nameStat = 'Атака';
    ...
    $this->log[] = 'Провал. <div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника защищает его и восстанавливает <span class="HpPlus">+'.ceil($watabs).' HP</span>.';
    }
    }else{
    $watabs = ($this->defender->stats[0] / 4);
    $this->defender->hp = ($this->defender->hp + $watabs);
    ...
    $this->log[] = 'Провал. <div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника защищает его и восстанавливает <span class="HpPlus">+'.ceil($skyd).' HP</span>.';
    }
    }else{
        $this->defender->_setModifiedStat('satk', 1, true);
    $this->log[] = 'Провал. <div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника защищает его и повышает Спец. Атаку.';
    }
}else{
    $this->log[] = 'Провал. <div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника защищает его.';
    }
    }
    }else{
  ...
  if($this->attackerAtk['id'] == 272 or $this->attackerAtk['id'] == 237 or $this->attackerAtk['id'] == 775) {
    ...
    $this->log[] = 'Промах травмирует '.$this->attacker->_getName(true).' <span class="HpMinus">-'.ceil($weatherMinusAbil).' HP</span>';
                ...
                if($this->attacker->ability == 168) {
                  ...
                  if(isset($text168)) {
                    $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> избавила покемона от некоторых статусов.';
                  }
                }
                ...
                if($this->attacker->ability == 184) {
                  $this->attacker->_setModifiedStat('spd', 1, true);
                  $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> повышает <span class="StatPlus">Скорость +1</span>';
                }
                ...
                if($this->attacker->ability == 147 && $this->_actionBattle->weather == 3 && !in_array(4,[$this->attacker->ability,$this->defender->ability])) {
                  ...
                  $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> восстанавливает покемону <span class="HpPlus">+'.ceil($weatherMinusAbil147).' HP</span>';
                }
                ...
                if($this->attacker->ability == 80 && $this->_actionBattle->weather == 4 && $this->attacker->item_id != 153 && !in_array(4,[$this->attacker->ability,$this->defender->ability])) {
                  ...
                  $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> восстанавливает покемону <span class="HpPlus">+'.ceil($abil80).' HP</span> и предотвращает урон от града.';
                }
                ...
                if($this->defenderAtk['id'] == 619) {
                  ...
                  $this->defender->_setModifiedStat('atk', 1, true);
                  $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника повышает ему <span class="StatPlus">Атаку +1</span>';
                }
  ...
  $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> противника повышает ему <span class="StatPlus">'.$this->statRus[$abil15_2][1].' +1</span>';
}
if($this->defender->ability == 3 && $this->attackerAtk['contact'] == 1) {
  ...
  $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> наносит противнику урон <span class="HpMinus">-'.$abil_3_hp.' HP</span>';
}
...
if($this->defender->ability == 170 && $this->attackerAtk['contact'] == 1) {
  ...
  if ($abil_170_hp > 0) {
    $this->log[] = '<div class="Ability" onclick="issetAll('.$this->defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->defender->ability,'name_rus']).'</div> ранит противника при контакте <span class="HpMinus">-'.$abil_170_hp.' HP</span>';
  }
}
}
}else{
...
//                     }else{
//                       $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> предотвращает урон от града.';
//                     }
//                   }
//                 }
//       				}
...
//                     }else{
//                       $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> предотвращает урон от песка.';
//                     }
//                   }
//       					}
//       				}
...
if($this->attacker->ability == 180 && $this->_actionBattle->weather == 2 && !in_array(4,[$this->attacker->ability,$this->defender->ability])) {
  ...
  $this->attacker->hp = ($this->attacker->hp - $weatherMinusAbil);
  $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$this->attacker->ability,'name_rus']).'</div> наносит урон <span class="HpMinus">-'.ceil($weatherMinusAbil).' HP</span>';
}
if($this->attackerAtk['id'] == 583) {
                            ...
                            if($this->attacker->ability != 80) {
                                if(!in_array($this->attacker->ability, [125,161])) {
                                    ...
                                    $this->log[] = '<div class="Ability" onclick="issetAll('.$this->attacker->ability.',\'ability\')">'
                                      .Info::getAbilityBase(['id',$this->attacker->ability,'name_rus'])
    ...
    if($def->_isHp()){
        ...
        */
        ...
        if(!empty($atkAtk['settings'])){
            ...
            if(isset($atkAtk['settings']['two_turn'])){
                $zarad = 0;
                $manyKick = 2;
                $manyKickTurn = 0;

                // Перезарядка после атаки (Hyper Beam-подобные)
                if(in_array($atkAtk['id'], [186,435,43,761])) {
                    $zarad = 1;
                }
                ...
                }elseif(in_array($atkAtk['id'], [186,43,761])){
                    $atkAtk['settings'] = NULL;
            ...
            if(isset($atkAtk['settings']['flowertrik'])){
                $chance_critical = 101;
            }
...
if(isset($atkAtk['settings']['count_hit'], $atkAtk['settings']['count_hit'][0], $atkAtk['settings']['count_hit'][1])){
    if($atkAtk['settings']['count_hit'][0] > 0){
        if($atk->ability == 174 && $atkAtk['settings']['count_hit'][0] == 2 && $atkAtk['settings']['count_hit'][1] == 5) {
            ...
            $count_hit = 5;
            $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> помогают нанести максимальное количество ударов.';
        }else{
        ...
        $this->log[] = 'Мощность атаки увеличена в х1';
            ...
            if($def->ability == 108 and $atk->ability != 113) {
              if($def->_checkStatus('toxic') || $def->_checkStatus('toxic2') || $def->_checkStatus('sleep') || $def->_checkStatus('burn') || $def->_checkStatus('frost') || $def->_checkStatus('paralyzed')) {
                ...
                $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> усиливает Защиту цели.';
              }
            }
            ...
            if($atk->ability == 180 && $this->_actionBattle->weather == 2 && !in_array(4,[$atk->ability,$def->ability])) {
              ...
              $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> увеличивает <span class="StatPlus">Спец. Атаку +50%</span>';
            }
            ...
            if($atk->ability == 70) {
              if($atk->_checkStatus('burn') || $atk->_checkStatus('toxic') || $atk->_checkStatus('toxic2') || $atk->_checkStatus('sleep') || $atk->_checkStatus('paralyzed') || $atk->_checkStatus('frost')){
                ...
                $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> увеличивает <span class="StatPlus">Атаку +50%</span>';
              }
            }
            ...
            if($atk->ability == 219 && $def->ability != 113) {
              ...
              $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> игнорирует модификаторы цели.';
            }
            if($def->ability == 219 && $atk->ability != 113) {
              ...
              $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> игнорирует модификаторы цели.';
            }
            ...
            if($def->ability == 210 and $atk->ability != 113 and ($atkAtk['type'] == 'fire' or $atkAtk['type'] == 'ice')){
                $atkDmg *= 0.5;
                $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> уменьшает урон в два раза.';
            }

            // Dry Skin (id=45): цель получает на 25% больше урона от огня
            if($def->ability == 45 and $atkAtk['type'] == 'fire' and $atk->ability != 113){
                $atkDmg *= 1.25;
                $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> увеличивает урон атаки на 25%.';
            }
            ...
            if($this->meFirst == 0 && $atk->ability == 5) {
              $atkDmg = $atkDmg * 1.3;
              $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> увеличивает мощность атаки на 30%.';
            }

            // Technician: усиливает атаки с силой 60 или меньше
            if($atkAtk['power'] <= 60 && $atk->ability == 207) {
              $atkDmg = $atkDmg * 1.5;
              $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> увеличивает мощность атаки на 50%.';
            }
            ...
            if($def->ability == 250 && $atkAtk['category'] == "special") {
              $atkDmg = $atkDmg * 0.5;
              $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> понижает мощность атаки на 50%.';
            }
            ...
            if($def->ability == 240 && $atkAtk['sound'] == 1) {
              $atkDmg = $atkDmg * 0.5;
              $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> уменьшает мощность атаки на 50%.';
            }

            // Iron Fist
            if($atk->ability == 91 && $atkAtk['punch'] == 1) {
              $atkDmg = $atkDmg * 1.2;
              $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> увеличивает мощность атаки на 20%.';
            }
            ...
            if($atk->ability == 153){
                if($atk->_getSex() == $def->_getSex()){
                    $atkDmg = $atkDmg * 1.25;
                    $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> увеличивает мощность атаки на 25%.';
                }else{
                    $atkDmg = $atkDmg * 0.75;
                    $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> уменьшает мощность атаки на 25%.';
                }
            }
            ...
            if($atkAtk['type'] == 'steel' && $atk->ability == 247) {
              $atkDmg = $atkDmg * 1.35;
              $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> увеличивает мощность атаки на 35%.';
            }
            ...
            if($this->_actionBattle->weather == 5 && $atk->ability == 158 && !in_array(4,[$atk->ability,$def->ability])) {
              if(in_array($atkAtk['type'], ['ground','steel','rock'])) {
                ...
                $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> увеличила мощность атаки на 30%.';
              }
            }
            ...
            if($atk->ability == 195) {
              if(!empty($atkAtk['bite']) && $atkAtk['bite'] == 1) {
                ...
                $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> увеличила мощность атаки на 50%.';
              }
            }
...
$randCrit = ($atk->item_id == 143 || $atk->_checkStatus('critfocus') || $atk->ability == 198 ? mt_rand(0, 70) : mt_rand(0, 100));

// STAB
$this->settings['stab'] = (($atkAtk['type'] == $atk->_getTypeA() || $atkAtk['type'] == $atk->_getTypeB()) ? 1.5 : 1);
if($this->settings['stab'] == 1.5 && $atk->ability == 1) { // Adaptability
  $this->settings['stab'] = 2;
  $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> увеличила STAB эффект от атаки с 1.5 до 2.';
}
...
if($this->settings['critical'] > 1 && in_array($def->ability, [170,13]) && $atk->ability != 113 ) {
  $this->settings['critical'] = 1;
  $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> спасает покемона противника от критического удара, который мог бы быть.';
}

// Sniper
if($this->settings['critical'] > 1 && $atk->ability == 177) {
  $this->settings['critical'] = 2.25;
  $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> значительно увеличивает урон от Критической атаки.';
}
...
if(
  ...
  $this->settings['types'] = 1;
  $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> позволяет бить по призракам.';
}
...
if($this->settings['types'] > 1){
    if($atk->ability != 221){
        ...
        $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> заставляет противника нервничать и мешает съесть плод.';
    }
}
...
if($this->settings['types'] <= 0.50 and $def->ability == 211){
    $this->settings['types'] = 1;
    $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> повышает урон до обычного.';
}
...
if($this->settings['types'] > 1 && $def->ability == 51 && $this->settings['dmg'] > 0 && $atk->ability != 113) {
  ...
  $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> противника снижает урон от атаки на 25%.';
}
}else{
  $this->settings['dmg'] += 0;
}
...
if($atkAtk['type'] == 'grass' && $def->ability == 162 && $this->settings['dmg'] > 0 && $atk->ability != 113) {
  ...
  $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> противника блокирует урон от атаки и повышает <span class="StatPlus">Атаку +1</span>.';
}
...
if($this->settings['dmg'] > 0){
  ...
  if($atkAtk['category'] == 'physical' && $atk->_checkStatus('burn') && $atkAtk['id'] != 152){
    if($atk->ability == 70) {
      $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> не дает снизить урон от атаки.';
    }else{
      $this->settings['dmg'] = floor($this->settings['dmg'] * 0.5);
    }
  }
  ...
  if($atkAtk['id'] == 125){
    ...
    if(isset($atkAtk['settings']['recoil'])){
      if($atk->ability == 155) {
        $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> защитила покемона от получения урона.';
      }else{
  ...
  if($atkAtk['type'] == 'fire' && $def->ability == 73 && $atk->ability != 113) {
    ...
    $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> уменьшает урон от атаки в два раза.';
  }

  // Wonder Guard (232): пропускает ТОЛЬКО суперэффективные удары
  if($this->settings['types'] <= 1 && $def->ability == 232 && $atk->ability != 113) {
    $this->settings['dmg'] = 0;
    $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> противника блокирует урон от атаки.';
  }

  // Flash Fire (226) получал половину? (у тебя так реализовано) — оставляю
  if($atkAtk['type'] == 'fire' && $def->ability == 226) {
    $this->settings['dmg'] = ceil($this->settings['dmg'] / 2);
    $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> уменьшает полученный урон в два раза.';
  }
  ...
  if($def->ability == 115 && $atkAtk['type'] == 'electric' && $this->settings['dmg'] > 0 && $atk->ability != 113) {
    ...
    $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> повышает противнику <span class="StatPlus">Скорость +1</span> и блокирует весь полученный урон от электрической атаки.';
  }
  ...
  if($hpBefore >= $def->hp_max && $def->hp <= 0 && (($def->ability == 196 && $atk->ability != 113) || $def->item_id == 9999) && !in_array($atkAtk['id'], [19,32,35,51,52,65,80,116,117,120,133,189,191,196,261,382,436,509,550,581,596,669,671,695,741])){
    ...
    if($def->item_id == 9999) {
      ...
      $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> защитила покемона от получения урона и оставила ему 1 очко здоровья.';
    }
  }
...
if($this->settings['dmg'] > 0 && $def->ability == 229 && $atkAtk['category'] == 'physical') {
    ...
    $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> повышает <span class="StatPlus">Скорость +2</span> и понижает <span class="StatMinus">Защиту -1</span>';
}
...
if($this->settings['dmg'] == 0) {
    ...
    if($def->ability == 187) {
        ...
        $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> противника повышает <span class="StatPlus">Защиту +1</span>';
    }
    ...
    if(($def->ability == 156 or $def->ability == 90) && $atkAtk['contact'] == 1) {
        $ab156 = ($atk->stats[0] / 8);
        $atk->hp = ($atk->hp - $ab156);
        $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> противника наносит урон <span class="HpMinus">-'.ceil($ab156).' HP</span>';
    }
    ...
    if($def->ability == 16) {
        ...
        if($abil16 > ($def->hp - $this->settings['dmg'])) {
            ...
            $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> противника повышает <span class="StatPlus">'.$this->statRus['satk'][1].' +1</span>';
        }
    }
    ...
    if($def->ability == 67 && $atkAtk['contact'] == 1 && $atk->ability != 23 ) {
        ...
        $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> противника понижает атакующему <span class="StatMinus">Скорость -1</span>';
    }
...
if(isset($atkAtk['settings'], $atkAtk['settings']['return_dmg'])){
    if($atk->ability == 155) {
        ...
        if($this->settings['dmg'] > $def->hp_max){
            $returnDmg = $def->hp_max * floatval($atkAtk['settings']['return_dmg']);
        }else{
...
if(in_array($this->settings['critical'], ['1.5','2.25']) && $this->settings['dmg'] > 0) {
    ...
    if($def->ability == 6) {
        ...
        $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> повышает <span class="StatPlus">Атаку +6</span> у противника.';
    }
}
}else{
      ...
      if(isset($uData['targetPS']) && $uData['targetPS'] > 0){
        ...
        if(!empty($target)){
          ...
          if($atk->id == $atk1->id) {
            ...
            if($def->ability == 23 ){
                $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> противника не дает понизить ему стат.';
            }else{
                $def->_setModifiedStat('satk',1,false);
    			if($def->ability == 79 && $atk->ability != 113 ) {
    				$this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> противника не дает понизить ему стат Атаки.';
    			}else{
...
private function trySynchronize($statusType) {
    if ($this->defender->ability == 204 && $this->attacker->hp > 0 && $this->settings['types'] > 0) {
        ...
        if ($statusType == 'burn'
            ...
            || $this->attacker->ability == 226 || ($this->attacker->ability == 228 && $this->defender->ability != 113))) $immune = true;
        if (($statusType == 'toxic' || $statusType == 'toxic2' || $statusType == 'poison')
            && (in_array($this->attacker->_getTypeA(), ['poison','steel']) || in_array($this->attacker->_getTypeB(), ['poison','steel']))) $immune = true;
        ...
        if (!$this->attacker->_checkStatus($statusType) && !$immune) {
            ...
            $this->log[] = '<div class="Ability" onclick="issetAll(204,\'ability\')">Синхронизация</div> заставляет '
    ...
    private function trySynchronizeBack($statusType) {

        if ($this->attacker->ability == 204 && $this->defender->hp > 0 && $this->settings['types'] > 0) {

            $immune = false;

            if ($this->defender->_checkStatus('safeguard') || $this->defender->_checkStatus('terrMisty')) {
                $immune = true;
            }

            if ($statusType == 'burn' && (in_array($this->defender->_getTypeA(), ['fire']) || in_array($this->defender->_getTypeB(), ['fire']) || $this->defender->ability == 226 || $this->defender->ability == 228)) {
                $immune = true;
            }

            if (($statusType == 'toxic' || $statusType == 'toxic2' || $statusType == 'poison') && (in_array($this->defender->_getTypeA(), ['poison','steel']) || in_array($this->defender->_getTypeB(), ['poison','steel']))) {
                $immune = true;
            }

            if ($statusType == 'paralyzed' && (in_array($this->defender->_getTypeA(), ['electric']) || in_array($this->defender->_getTypeB(), ['electric']))) {
                $immune = true;
            }

            if (!$this->defender->_checkStatus($statusType) && !$immune) {

                $this->defender->_setStatus($statusType, 9999);
                $this->log[] = '<div class="Ability" onclick="issetAll(204,\'ability\')">Синхронизация</div> заставляет '.$this->defender->_getName(true).' получить статус '.$statusType.'!';
            ...
            foreach($pList AS $key_1=>&$value_1){
                if($value_1['id'] == $other) {
                    ...
                    if(isset($value_1['ability']) && $value_1['ability'] == 96 && $def->ability != 113) {
                        $this->log[] = '<div class="Ability" onclick="issetAll('.$value_1['ability'].',\'ability\')">'.Info::getAbilityBase(['id',$value_1['ability'],'name_rus']).'</div> позволяет '.$newPokemon->_getName(true).' левитировать.';
                    ...
                    if(isset($value_1['ability']) && $value_1['ability'] == 255) {
                        ...
                        $this->log[] = '<div class="Ability" onclick="issetAll('.$value_1['ability'].',\'ability\')">'.Info::getAbilityBase(['id',$value_1['ability'],'name_rus']).'</div> повышает Атаку '.$newPokemon->_getName(true);
                    }
                    if(isset($value_1['ability']) && $value_1['ability'] == 256) {
                        ...
                        $this->log[] = '<div class="Ability" onclick="issetAll('.$value_1['ability'].',\'ability\')">'.Info::getAbilityBase(['id',$value_1['ability'],'name_rus']).'</div> повышает Защиту '.$newPokemon->_getName(true);
                    }
                    if(isset($value_1['ability']) && $value_1['ability'] == 89) {
                        if($def->ability == 79 && $atk->ability != 113) {
                            ...
                            $def->_setModifiedStat('atk', 1, false);
                            $this->log[] = '<div class="Ability" onclick="issetAll('.$value_1['ability'].',\'ability\')">'.Info::getAbilityBase(['id',$value_1['ability'],'name_rus']).'</div> уменьшает противнику <span class="StatMinus">Атаку -1</span>';
                        }
                    }
                    if(isset($value_1['ability']) && $value_1['ability'] == 249 && (($def->_checkStatus('lightScreen') || $def->_checkStatus('reflect') || $def->_checkStatus('aurora')) || (isset($value_1['status_list']['lightScreen']) || isset($value_1['status_list']['reflect']) || isset($value_1['status_list']['aurora'])))) {
                        ...
                        $this->log[] = '<div class="Ability" onclick="issetAll('.$value_1['ability'].',\'ability\')">'.Info::getAbilityBase(['id',$value_1['ability'],'name_rus']).'</div> разрушает экраны на поле боя';
                    }
                    if(isset($value_1['ability']) && $value_1['ability'] == 44) {
                        ...
                        $this->log[] = '<div class="Ability" onclick="issetAll('.$value_1['ability'].',\'ability\')">'.Info::getAbilityBase(['id',$value_1['ability'],'name_rus']).'</div> меняет погоду на Солнечную.';
                    }
                    if(isset($value_1['ability']) && $value_1['ability'] == 179) {
                        ...
                        $this->log[] = '<div class="Ability" onclick="issetAll('.$value_1['ability'].',\'ability\')">'.Info::getAbilityBase(['id',$value_1['ability'],'name_rus']).'</div> меняет погоду на Град.';
                    }
                    if(isset($value_1['ability']) && $value_1['ability'] == 43) {
                        ...
                        $this->log[] = '<div class="Ability" onclick="issetAll('.$value_1['ability'].',\'ability\')">'.Info::getAbilityBase(['id',$value_1['ability'],'name_rus']).'</div> меняет погоду на Дождь.';
                    }
                    if(isset($value_1['ability']) && $value_1['ability'] == 160) {
                        ...
                        $this->log[] = '<div class="Ability" onclick="issetAll('.$value_1['ability'].',\'ability\')">'.Info::getAbilityBase(['id',$value_1['ability'],'name_rus']).'</div> меняет погоду на Песчаную бурю.';
                    }
                }
            }
        }
                ...
                if(!in_array($atkAtk['id'], [34,583,592,374,229])){
                    if($atk->hp > 0) {
                        if(
                            ...
                            $this->log[] = 'Пытается сменить покемона, но <div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> противника не дает это сделать.';
                            return false;
                        }
                    }
                }
...
// === КОНЕЦ NATURAL CURE ===
            ...
            if(isset($uData['targetPokemon']) && $uData['targetPokemon'] > 0){
                  if(isset($atkAtk['id'])){
                    ...
                    if($atk->ability == 44) {
                      Work::$sql->query("UPDATE battle SET `weather` = 2, weather_round = 5 WHERE user_1 = ".$atk->user_id." OR user_2 = ".$atk->user_id);
                      $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> меняет погоду на Солнечную.';
                    }
                    if($atk->ability == 179) {
                      Work::$sql->query("UPDATE battle SET `weather` = 4, weather_round = 5 WHERE user_1 = ".$atk->user_id." OR user_2 = ".$atk->user_id);
                      $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> меняет погоду на Град.';
                    }

                    if($atk->ability == 43) {
                      Work::$sql->query("UPDATE battle SET `weather` = 3, weather_round = 5 WHERE user_1 = ".$atk->user_id." OR user_2 = ".$atk->user_id);
                      $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> меняет погоду на Дождь.';
                    }
                    if($atk->ability == 160) {
                      Work::$sql->query("UPDATE battle SET `weather` = 5, weather_round = 5 WHERE user_1 = ".$atk->user_id." OR user_2 = ".$atk->user_id);
                      $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> меняет погоду на Песчанную Бурю.';
                    }
                    ...
                    if($atk->ability == 96 and $def->ability != 113) {
                      ...
                      $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> позволяет '.$atk->_getName(true).' левитировать.';
                    }
                    if(isset($valToxicSpikes)) {
                      if($valToxicSpikes == 1) {
                    ...
                    if(isset($valRocks)) {
                      ...
                      if($atk->ability == 255) {
							  $atk->_setModifiedStat('atk', 1, true);
	                          $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> повышает Атаку '.$atk->_getName(true);

                      }

                      if($atk->ability == 256) {
							  $atk->_setModifiedStat('def', 1, true);
	                          $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> повышает Защиту '.$atk->_getName(true);
                      ...
                      if($atk->ability == 89) {
						  if($def->ability == 79 && $atk->ability != 113) {
							  ...
							  $def->_setModifiedStat('atk', 1, false);
	                          $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> уменьшает противнику <span class="StatMinus">Атаку -1</span>';
						  }
                      }
                ...
                $info2 = $def->_getStatusList();
			                        ...
			                        $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> разрушает экраны на поле боя';
    ...
    if($atk->hp > 0){
        ...
        if($atk->_checkStatus('flinch')){
            ...
            if($atk->ability == 87 && $def->ability != 113) {
                $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> предотвращает испуг у покемона.';
            }else{
                $this->log[] = 'Но '.$atk->_getName(true).' напуган и не желает делать это действие.';
                // Сохраняю твою механику для 190 (увеличение Атаки)
                if($atk->ability == 190) {
                    $atk->_setModifiedStat('atk', 1, true);
                    $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> повышает <span class="StatPlus">Атаку +1</span>';
                }
                return false;
            }
        }
        ...
        if( ($atk->ability == 33 && in_array($atkAtk['id'], [149,466,641])) || ($def->ability == 33 && in_array($atkAtk['id'], [149,466,641])) ){
            $this->log[] = 'Но <div class="Ability" onclick="issetAll(33,\'ability\')">'.Info::getAbilityBase(['id',33,'name_rus']).'</div> не дает использовать самоубийственную атаку.';
            return false;
        }
        ...
        if ($atk->basenum == 681 && $atk->ability == 188 && in_array($atkAtk['category'], ['physical','special'])) {
            if ($atk->form == 0 or $atk->form == "") {
                $atk->form = "blade";
                $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> меняет форму на Меч.';
            }
        }
    }
...
private function issetEffect(PokeBattle $atk, PokeBattle $def, array &$atkAtk, array &$defAtk, $my = false){
    ...
    if(!empty($info)){
                ...
                if($value && isset($value[0], $value[1], $value[2]) && $value[0] > 0 && mt_rand(1,100) <= $value[0]){
                    ...
                    if($value[1] == 'sleep') {
                        if( ($this->settings['dmg'] <= 0 && in_array($atkAtk['category'], ['special','physical']))
                            ...
                            $this->log[] = 'Провал изменения статуса.';
                            if($def->ability == 88) {
                                $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> защищает от усыпления.';
                            }
                            continue;
                        }
                    }
                    ...
                    if($value[1] == 'burn'){
                        if( ($this->settings['dmg'] <= 0 && in_array($atkAtk['category'], ['special','physical']))
                            ...
                            if($def->ability == 226 or $def->ability == 228) {
                                $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> защищает от поджога.';
                            }
                            continue;
                        }
                    }
                    ...
                    if( $def->_setStatus( $value[1], $value[2], (isset($value[3]) ? $value[3] : null) ) ){
                        ...
                        if (in_array($value[1], ['burn','toxic','toxic2','poison','paralyzed'])) {
        ...
        if(isset($info['heal'])){
            if($atk->ability == 109) {
                $info['heal'] = 0.75;
                $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> усиливает лечение от атаки.';
            }
        ...
        if(isset($info['heal_dmg']) && $info['heal_dmg'] > 0){
            if($this->settings['dmg'] > 0){
                ...
                $healHp = ($this->settings['dmg'] * floatval($info['heal_dmg']));
                if($this->settings['dmg'] > $def->stats[0]){
    ...
    //     }
        ...
        if ($atkAtk['id'] == '315') {
            if ($def->ability == 79 && $atk->ability != 113) {
                ...
                $this->log[] = '<div class="Ability" onclick="issetAll('.$def->ability.',\'ability\')">'.Info::getAbilityBase(['id',$def->ability,'name_rus']).'</div> противника не дает понизить ему статы.';
            } else {
        ...
        if ($atkAtk['id'] == '429') {
            if ($atk->ability == 88 && $def->ability != 113) {
                $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> не дает использовать эту атаку.';
            } else {
            ...
            foreach($info AS $key => &$value){
                ...
                if(isset($value['type'], $value['count']) && $value['count'] > 0){
                        ...
                        switch($value['type']){
                            ...
                            case 'sleep':
                                if($defender->ability == 11 and $attacker->item_id != 168) {
                                    $hp = round(($attacker->hp_max) / 8);
                                    $attacker->hp = $attacker->hp - $hp;
                                    $this->log_status[] = '<div class="Ability" onclick="issetAll('.$defender->ability.',\'ability\')">'.Info::getAbilityBase(['id',$defender->ability,'name_rus']).'</div> противника наносит урон покемону: <span class="HpMinus">-'.$hp.' HP</span>';
                                }
                                break;
                            ...
                            case 'burn':
                                ...
                                if($attacker->ability == 73 and $defender->ability != 113) {
                                    $hp = ceil($hp / 2);
                                    $this->log_status[] = '<div class="Ability" onclick="issetAll('.$attacker->ability.',\'ability\')">'.Info::getAbilityBase(['id',$attacker->ability,'name_rus']).'</div> уменьшает урон от огня в два раза.';
                                }
                                $attacker->hp = $attacker->hp - $hp;
                    ...
                    unset($info[$key]);
                        ...
                        // ===== ДОБАВЛЕНО: Погодный урон/эффекты (Hail/Sandstorm) как в PokemonShowdown =====
            if($isHp > 0 && !in_array(4, [$attacker->ability, $defender->ability])){

                if($this->_actionBattle->weather == 4){

                    if(!in_array($attacker->_getTypeA(), ['ice']) && !in_array($attacker->_getTypeB(), ['ice']) && $attacker->ability != 125){

                        $hp = max(1, floor($attacker->hp_max / 16));
                        $attacker->hp = $attacker->hp - $hp;
                        $this->log_status[] = 'Град наносит урон '.$attacker->_getName(true).' <span class="HpMinus">-'.$hp.' HP</span>';
                        $attacker->_updateHp();
                        $isHp = $attacker->hp;
                    ...
                    if(!in_array($attacker->_getTypeA(), ['rock','ground','steel']) && !in_array($attacker->_getTypeB(), ['rock','ground','steel']) && $attacker->ability != 125){

                        $hp = max(1, floor($attacker->hp_max / 16));
                        $attacker->hp = $attacker->hp - $hp;
                        $this->log_status[] = 'Песчаная буря наносит урон '.$attacker->_getName(true).' <span class="HpMinus">-'.$hp.' HP</span>';
                        $attacker->_updateHp();
                        $isHp = $attacker->hp;
...
private function abil_overcoat(PokeBattle $atk, PokeBattle $def, array &$atkAtk, array &$defAtk){
    ...
    if (in_array((int)$atkAtk['id'], $powderIds, true)) {
        if ($def->ability == 125) {
            $this->log[] = '<div class="Ability" onclick="issetAll(125,\'ability\')">'.Info::getAbilityBase(['id',125,'name_rus']).'</div> защищает от пыльцевых атак.';
            return false;
        }
    }
    return true;
...
private function abil_aromaveil(PokeBattle $atk, PokeBattle $def, array &$atkAtk, array &$defAtk){
    ...
    if (in_array((int)$atkAtk['id'], $mentalIds, true)) {
        if ($def->ability == 9) {
            $this->log[] = '<div class="Ability" onclick="issetAll(9,\'ability\')">'.Info::getAbilityBase(['id',9,'name_rus']).'</div> защищает от ментальных приёмов.';
            return false;
        }
    }
    return true;
...
private function abil_soundproof(PokeBattle $atk, PokeBattle $def, array &$atkAtk, array &$defAtk){
    ...
    if (!empty($atkAtk['sound']) && (int)$atkAtk['sound'] === 1) {
        if ($def->ability == 183) {
            $this->log[] = '<div class="Ability" onclick="issetAll(183,\'ability\')">'.Info::getAbilityBase(['id',183,'name_rus']).'</div> блокирует звуковую атаку.';
            return false;
        }
    }
    return true;
...
private function abil_bulletproof(PokeBattle $atk, PokeBattle $def, array &$atkAtk, array &$defAtk){
    ...
    if (!empty($atkAtk['bullet']) && (int)$atkAtk['bullet'] === 1) {
        if ($def->ability == 19) {
            $this->log[] = '<div class="Ability" onclick="issetAll(19,\'ability\')">'.Info::getAbilityBase(['id',19,'name_rus']).'</div> блокирует снаряд-атаку.';
            return false;
        }
    }
    return true;
...
private function abil_dryskin(PokeBattle $atk, PokeBattle $def, array &$atkAtk, array &$defAtk){
    ...
    if ($def->ability == 45 && $atkAtk['type'] === 'water' && $atk->ability != 113) {
        ...
        if ($atkAtk['target'] === 'enemy' && in_array($atkAtk['category'], ['physical','special'], true) && (int)$atkAtk['power'] > 0) {
            ...
            $this->log[] = '<div class="Ability" onclick="issetAll(45,\'ability\')">'.Info::getAbilityBase(['id',45,'name_rus']).'</div> поглощает воду и лечит '.$def->_getName(true).' на <span class="HpPlus">+'.$heal.' HP</span>.';
        } else {
            $this->log[] = '<div class="Ability" onclick="issetAll(45,\'ability\')">'.Info::getAbilityBase(['id',45,'name_rus']).'</div> делает покемона невосприимчивым к воде.';
        }
        return false;
    }
    return true;
...
private function abil_waterabsorb(PokeBattle $atk, PokeBattle $def, array &$atkAtk, array &$defAtk){
    ...
    if ($def->ability == 225 && $atkAtk['type'] === 'water' && $atk->ability != 113) {
        if ($atkAtk['target'] === 'enemy' && in_array($atkAtk['category'], ['physical','special'], true) && (int)$atkAtk['power'] > 0) {
            $heal = (int)floor($def->hp_max * 0.25);
            $def->hp = min($def->hp + $heal, $def->hp_max);
            $this->log[] = '<div class="Ability" onclick="issetAll(225,\'ability\')">'.Info::getAbilityBase(['id',225,'name_rus']).'</div> поглощает воду и лечит '.$def->_getName(true).' на <span class="HpPlus">+'.$heal.' HP</span>.';
        } else {
            $this->log[] = '<div class="Ability" onclick="issetAll(225,\'ability\')">'.Info::getAbilityBase(['id',225,'name_rus']).'</div> делает покемона невосприимчивым к воде.';
        }
        return false;
    }
    return true;
...
private function abil_voltabsorb(PokeBattle $atk, PokeBattle $def, array &$atkAtk, array &$defAtk){
    ...
    if ($def->ability == 224 && $atkAtk['type'] === 'electric' && $atk->ability != 113) {
        if ($atkAtk['target'] === 'enemy' && in_array($atkAtk['category'], ['physical','special'], true) && (int)$atkAtk['power'] > 0) {
            $heal = (int)floor($def->hp_max * 0.25);
            $def->hp = min($def->hp + $heal, $def->hp_max);
            $this->log[] = '<div class="Ability" onclick="issetAll(224,\'ability\')">'.Info::getAbilityBase(['id',224,'name_rus']).'</div> поглощает электричество и лечит '.$def->_getName(true).' на <span class="HpPlus">+'.$heal.' HP</span>.';
        } else {
            $this->log[] = '<div class="Ability" onclick="issetAll(224,\'ability\')">'.Info::getAbilityBase(['id',224,'name_rus']).'</div> делает покемона невосприимчивым к электричеству.';
        }
        return false;
    }
    return true;
...
private function abil_sapsipper(PokeBattle $atk, PokeBattle $def, array &$atkAtk, array &$defAtk){
    ...
    if ($atkAtk['type'] === 'grass' && $atkAtk['target'] === 'enemy' && $def->ability == 162 && $atk->ability != 113) {
        $def->_setModifiedStat('atk', 1, true);
        $this->log[] = '<div class="Ability" onclick="issetAll(162,\'ability\')">'.Info::getAbilityBase(['id',162,'name_rus']).'</div> противника повышает ему <span class="StatPlus">'.$this->statRus['atk'][1].' +1</span>';
        return false;
    }
    return true;
}
...
private function abil_flashfire(PokeBattle $atk, PokeBattle $def, array &$atkAtk, array &$defAtk){
    ...
    if ($atkAtk['type'] === 'fire' && $atkAtk['target'] === 'enemy' && $def->ability == 54 && $atk->ability != 113) {
        ...
        $this->log[] = '<div class="Ability" onclick="issetAll(54,\'ability\')">'.Info::getAbilityBase(['id',54,'name_rus']).'</div> поглощает огонь. Силa огненных атак '.$def->_getName(true).' усиливается.';
        return false;
    }
    return true;
}
...
private function abil_lightningrod(PokeBattle $atk, PokeBattle $def, array &$atkAtk, array &$defAtk){
    ...
    if ($atkAtk['type'] === 'electric' && $atkAtk['target'] === 'enemy' && $def->ability == 98 && $atk->ability != 113) {
        $def->_setModifiedStat('satk', 1, true);
        $this->log[] = '<div class="Ability" onclick="issetAll(98,\'ability\')">'.Info::getAbilityBase(['id',98,'name_rus']).'</div> притягивает электричество и повышает Спец.Атаку защищающегося.';
        return false;
    }
    return true;
}
...
private function isAccuracy(PokeBattle $atk, PokeBattle $def, array &$atkAtk, array &$defAtk){
    ...
    if ($atk->ability == 28) {
        ...
        $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> увеличивает точность атаки в 1.3 раза.';
    }
    if ($atk->ability == 222) {
        $atkAtk['accuracy'] = $atkAtk['accuracy'] * 1.1;
        $this->log[] = '<div class="Ability" onclick="issetAll('.$atk->ability.',\'ability\')">'.Info::getAbilityBase(['id',$atk->ability,'name_rus']).'</div> увеличивает точность атаки на 10%.';
    }
