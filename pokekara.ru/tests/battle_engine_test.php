...
$state = [
  ...
  'p1' => [
    ...
    'moves' => [
      ['slot'=>1,'pp_current'=>35,'pp_max'=>35,'name'=>'Tackle','type'=>'normal','category'=>'physical','power'=>40,'accuracy'=>100,'priority'=>0],
      ['slot'=>2,'pp_current'=>25,'pp_max'=>25,'name'=>'Vine Whip','type'=>'grass','category'=>'physical','power'=>45,'accuracy'=>100,'priority'=>0],
      ['slot'=>3,'pp_current'=>30,'pp_max'=>30,'name'=>'Quick Attack','type'=>'normal','category'=>'physical','power'=>40,'accuracy'=>100,'priority'=>1],
      ['slot'=>4,'pp_current'=>40,'pp_max'=>40,'name'=>'Growl','type'=>'normal','category'=>'status','power'=>null,'accuracy'=>100,'priority'=>0],
    ],
  ],
  'p2' => [
    'level' => 5,
    ...
    'boosts' => ['atk'=>0,'def'=>0,'spa'=>0,'spd'=>0,'spe'=>0,'accuracy'=>0,'evasion'=>0],
    'moves' => [
      ['slot'=>1,'pp_current'=>25,'pp_max'=>25,'name'=>'Water Gun','type'=>'water','category'=>'special','power'=>40,'accuracy'=>100,'priority'=>0],
    ],
  ],
];
...
// Test: status move (Growl) should reduce target atk by 1 stage (down to -1)
$rng3 = new Rng($seed);
$res3 = BattleEngine::step($state, ['type'=>'move','slot'=>4], ['type'=>'move','slot'=>1], $rng3);
assertTrue(($res3['state']['p2']['boosts']['atk'] ?? 0) === -1, 'growl should lower atk');
